...
export const typeDefs = /* GraphQL */ `type AggregateAPIDashboard {
  count: Int!
}

type AggregateAPISettingDashboard {
  count: Int!
}
...
type APIDashboardConnection {
  pageInfo: PageInfo!
  edges: [APIDashboardEdge]!
  aggregate: AggregateAPIDashboard!
}

input APIDashboardCreateInput {
  settings: APISettingDashboardCreateOneInput!
  name: String!
  CommentAPI: CommentAPICreateOneInput!
}

type APIDashboardEdge {
  node: APIDashboard!
  cursor: String!
}

enum APIDashboardOrderByInput {
  id_ASC
  id_DESC
  name_ASC
  name_DESC
...
type APIDashboardPreviousValues {
  id: ID!
  name: String!
  createdAt: DateTime!
  updatedAt: DateTime!
...
type APIDashboardSubscriptionPayload {
  mutation: MutationType!
  node: APIDashboard
  updatedFields: [String!]
  previousValues: APIDashboardPreviousValues
}

input APIDashboardSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: APIDashboardWhereInput
  AND: [APIDashboardSubscriptionWhereInput!]
  OR: [APIDashboardSubscriptionWhereInput!]
  NOT: [APIDashboardSubscriptionWhereInput!]
}

input APIDashboardUpdateInput {
  settings: APISettingDashboardUpdateOneRequiredInput
  name: String
  CommentAPI: CommentAPIUpdateOneRequiredInput
}

input APIDashboardUpdateManyMutationInput {
  name: String
}

input APIDashboardWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  id_ends_with: ID
  id_not_ends_with: ID
  settings: APISettingDashboardWhereInput
  name: String
  name_not: String
  name_in: [String!]
  name_not_in: [String!]
  ...
  CommentAPI: CommentAPIWhereInput
  AND: [APIDashboardWhereInput!]
  OR: [APIDashboardWhereInput!]
  NOT: [APIDashboardWhereInput!]
}

input APIDashboardWhereUniqueInput {
  id: ID
}

type APISettingDashboard {
  id: ID!
  enforceHTTPS: Boolean!
}

type APISettingDashboardConnection {
  pageInfo: PageInfo!
  edges: [APISettingDashboardEdge]!
  aggregate: AggregateAPISettingDashboard!
}

input APISettingDashboardCreateInput {
  enforceHTTPS: Boolean!
}

input APISettingDashboardCreateOneInput {
  create: APISettingDashboardCreateInput
  connect: APISettingDashboardWhereUniqueInput
}

type APISettingDashboardEdge {
  node: APISettingDashboard!
  cursor: String!
}

enum APISettingDashboardOrderByInput {
  id_ASC
  id_DESC
  enforceHTTPS_ASC
  enforceHTTPS_DESC
...
type APISettingDashboardPreviousValues {
  id: ID!
  enforceHTTPS: Boolean!
}

type APISettingDashboardSubscriptionPayload {
  mutation: MutationType!
  node: APISettingDashboard
  updatedFields: [String!]
  previousValues: APISettingDashboardPreviousValues
}

input APISettingDashboardSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: APISettingDashboardWhereInput
  AND: [APISettingDashboardSubscriptionWhereInput!]
  OR: [APISettingDashboardSubscriptionWhereInput!]
  NOT: [APISettingDashboardSubscriptionWhereInput!]
}

input APISettingDashboardUpdateDataInput {
  enforceHTTPS: Boolean
}

input APISettingDashboardUpdateInput {
  enforceHTTPS: Boolean
}

input APISettingDashboardUpdateManyMutationInput {
  enforceHTTPS: Boolean
}

input APISettingDashboardUpdateOneRequiredInput {
  create: APISettingDashboardCreateInput
  update: APISettingDashboardUpdateDataInput
  upsert: APISettingDashboardUpsertNestedInput
  connect: APISettingDashboardWhereUniqueInput
}

input APISettingDashboardUpsertNestedInput {
  update: APISettingDashboardUpdateDataInput!
  create: APISettingDashboardCreateInput!
}

input APISettingDashboardWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  AND: [APISettingDashboardWhereInput!]
  OR: [APISettingDashboardWhereInput!]
  NOT: [APISettingDashboardWhereInput!]
}

input APISettingDashboardWhereUniqueInput {
  id: ID
}
...
input CommentAPICreateOneInput {
...
input CommentAPIUpdateOneRequiredInput {
  create: CommentAPICreateInput
  update: CommentAPIUpdateDataInput
  upsert: CommentAPIUpsertNestedInput
  connect: CommentAPIWhereUniqueInput
}

input CommentAPIUpsertNestedInput {
  update: CommentAPIUpdateDataInput!
  create: CommentAPICreateInput!
}
...
type Mutation {
  createAPIDashboard(data: APIDashboardCreateInput!): APIDashboard!
  updateAPIDashboard(data: APIDashboardUpdateInput!, where: APIDashboardWhereUniqueInput!): APIDashboard
  updateManyAPIDashboards(data: APIDashboardUpdateManyMutationInput!, where: APIDashboardWhereInput): BatchPayload!
  upsertAPIDashboard(where: APIDashboardWhereUniqueInput!, create: APIDashboardCreateInput!, update: APIDashboardUpdateInput!): APIDashboard!
  deleteAPIDashboard(where: APIDashboardWhereUniqueInput!): APIDashboard
  deleteManyAPIDashboards(where: APIDashboardWhereInput): BatchPayload!
  createAPISettingDashboard(data: APISettingDashboardCreateInput!): APISettingDashboard!
  updateAPISettingDashboard(data: APISettingDashboardUpdateInput!, where: APISettingDashboardWhereUniqueInput!): APISettingDashboard
  updateManyAPISettingDashboards(data: APISettingDashboardUpdateManyMutationInput!, where: APISettingDashboardWhereInput): BatchPayload!
  upsertAPISettingDashboard(where: APISettingDashboardWhereUniqueInput!, create: APISettingDashboardCreateInput!, update: APISettingDashboardUpdateInput!): APISettingDashboard!
  deleteAPISettingDashboard(where: APISettingDashboardWhereUniqueInput!): APISettingDashboard
  deleteManyAPISettingDashboards(where: APISettingDashboardWhereInput): BatchPayload!
...
type Query {
  aPIDashboard(where: APIDashboardWhereUniqueInput!): APIDashboard
  aPIDashboards(where: APIDashboardWhereInput, orderBy: APIDashboardOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [APIDashboard]!
  aPIDashboardsConnection(where: APIDashboardWhereInput, orderBy: APIDashboardOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): APIDashboardConnection!
  aPISettingDashboard(where: APISettingDashboardWhereUniqueInput!): APISettingDashboard
  aPISettingDashboards(where: APISettingDashboardWhereInput, orderBy: APISettingDashboardOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [APISettingDashboard]!
  aPISettingDashboardsConnection(where: APISettingDashboardWhereInput, orderBy: APISettingDashboardOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): APISettingDashboardConnection!
...
type Subscription {
  aPIDashboard(where: APIDashboardSubscriptionWhereInput): APIDashboardSubscriptionPayload
  aPISettingDashboard(where: APISettingDashboardSubscriptionWhereInput): APISettingDashboardSubscriptionPayload
